...
public class Console extends DefaultConsole {
	 ...
	 * 
	 * @throws Exception Si no se puede obtener el valor o comunicar con el
	 *                   servidor.
	 */
	...
	/**
	 * Menú para poder pedir al usuario una clave, un valor y mandar al servidor la
	...
	private void viewAllValues() throws Exception {
		...
		final SelectionMenu selectionMenu = new SelectionMenu(
				"\t", new ArrayList<Object>(values.keySet()), header) {
			@Override
