 ...
 * y realizar las diferentes operaciones que pueden ser enviadas en una petición
 * (Request)
 * en la cache distribuida.
 */
public interface Service {
	/**
	 * Dada una petición, se obtienen sus atributos y se realiza la operación en la
	 * cache
