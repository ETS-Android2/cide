...
public class Response {
    ...
    /**
     * Codifica la respuesta para poder ser enviada de una manera que el cliente entienda.
     * 
     ...
     * un String se obtiene un objecto Response con los datos encapsulados de la respuesta.
     * 
