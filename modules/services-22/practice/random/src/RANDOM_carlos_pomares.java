 ...
 * 
 * Cree un proceso hijo que esté encargado de generar números aleatorios. Para su creación puede utilizar cualquier lenguaje de programación, generando el ejecutable correspondiente.
 * Este proceso hijo escribirá en su salida estándar un número aleatorio del 0 al 10 cada vez que reciba una petición por parte del padre (esta petición será simplemente pulsando intro en el teclado).
 * 
 * Nota: no es necesario utilizar JNI, sólo crear un ejecutable y llamar correctamente al mismo desde Java.
 * El proceso padre lee líneas de la entrada estándar y por cada línea que lea solicitará al hijo que le envíe un número aleatorio, lo leerá y lo imprimirá en la pantalla.
 * 
 * Cuando el proceso padre reciba la palabra "fin" (escrita desde el teclado), finalizará la ejecución del hijo y procederá a finalizar su ejecución.
 * 
 * @author Carlos Pomares (https://www.github.com/pomaretta)
 * 
 */

public class RANDOM_carlos_pomares {
     ...
     */
    public RANDOM_carlos_pomares(ProcessBuilder builder) throws Exception {
    ...
    public void mainLoop() throws Exception {
        ...
        System.out.println("Para finalizar el programa de manera correcta, escriba la orden \"fin\".");
        ...
        do {
            ...
            try {
                ...
                System.out.print("random@pomaretta $ ");
    ...
    public static void main(String[] args) {
        ...
        String[] command = new String[]{
            "java",
            "-cp",
            RANDOM_carlos_pomares.class.getProtectionDomain().getCodeSource().getLocation().getPath(),
            "RANDOM_Child_carlos_pomares",
        };
        ...
        RANDOM_carlos_pomares app = null;
        ...
        try {
            app = new RANDOM_carlos_pomares(pb);
        } catch (Exception e) {
