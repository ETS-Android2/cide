...
public class StatisticResult extends FileAPI {
     ...
     */
    public StatisticResult(InputStream stream, char delimiter, int numberOfData, int flag, int data) throws IOException {
     ...
     * @throws IOException if something of the Input/Output fails.
     */
    public StatisticResult(InputStream stream, char delimiter, int numberOfData, int flag, int data, int identifier, String id) throws IOException {
